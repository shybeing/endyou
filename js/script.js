...
const commands = {
    ...
    about: {
        cmd: 'about',
        res: 'About Us:<br># <span class="red">Name:</span> endyou<br># <span class="red">Founded:</span> 2016 <br># <span class="red">Country:</span> United States<br><br><span class="red">Bio:</span><br><span class="pink">Recently graduated student with an Associate\'s of<br>Applied Science in Software Development. Work experience<br>in IT and retail, plus educational and personal exposure<br>with programming of all sorts (web apps, smart contracts,<br>application development, etc.)<br></span><br># <span class="red">Skills:</span> Programming, Graphic Design, Video Editing, 3D Modeling.<br></span><br># <span class="red">Programming:</span> HTML, CSS, JS, C++, C#, PYTHON, JAVA, PROCESSING, SOLIDITY.<br></span><br><span class="red">Languages:</span><br>* English - <span class="red">Native</span><br>* Hebrew - <span class="red">Intermediate</span><br>* Spanish - <span class="red">Basic</span><br>* Japanese - <span class="red">Beginner</span><br>'
    },
    links: {
        cmd: 'links',
        res: 'Links: <br># <span class="red"><a href="https://www.youtube.com/@shybeing" target="_blank">shybeing youtube</a></span><br># <span class="red"><a href="https://www.instagram.com/endy0u/" target="_blank">instagram</a></span><br># <span class="red"><a href="https://twitter.com/ENDY0U" target="_blank">twitter</a></span><br># <span class="red"><a href="https://steamcommunity.com/groups/endyou" target="_blank">steam group</a></span>'
    },
    help: {
        cmd: 'help',
        res: 'Available commands:<br><br># <span class="red">about</span> - Some information about me.<br># <span class="red">clear</span> - Clears console. <br># <span class="red">systeminfo</span> - Fetches system information in the terminal.<br># <span class="red">links</span> - Other socials.<br># <span class="red">music</span> - Usage: music [play/stop]'
    }
}
...
function launchCommandAsRoot(command) {
    var res = '';
    if (command === 'motd') res = '<br>Welcome to <span class="red">endyou.net</span>!<br><br><span class="red">&#x2002.########.##....##.########..##....##..#######..##.....##&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002<br>&#x2002.##.......###...##.##.....##..##..##..##.....##.##.....##&#x2002&#x2002&#x2002&#x2002&#x2002<br>..##.......####..##.##.....##...####...##.....##.##.....##&#x2002&#x2002&#x2002&#x2002<br>..######...##.##.##.##.....##....##....##.....##.##.....##&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002<br>&#x2002&#x2002##.......##..####.##.....##....##....##.....##.##.....##&#x2002&#x2002&#x2002&#x2002<br>&#x2002.##.......##...###.##.....##....##....##.....##.##.....##&#x2002<br>&#x2002.########.##....##.########.....##.....#######...#######.</p></div></span><br>Site By:</span ><span class="red"> <a href="http://www.worstpart.xyz/" target="_blank">worstpart</a> & <a href="https://www.youtube.com/shybeing" target="_blank">shybeing</a></span><br>Total Visits: <span class="red">16245</span> <height="15px" border="0"></img><span class="red">' + '</span><br>Terminal Updated: <span class="red">' + lastUpdate + '</span><br><br><b>Type <span class="green">\'help\'</span> for more details on the commands</b>'
    else {
    ...
    try {
        ...
        if (root > 0) {
            ...
            if (vInput.startsWith("./")) {
                ...
                launchCommandAsVisitor({
                    cmd: $('input').val(),
                    res: '<span class="red">&#x2002.########.##....##.########..##....##..#######..##.....##&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002<br>&#x2002.##.......###...##.##.....##..##..##..##.....##.##.....##&#x2002&#x2002&#x2002&#x2002&#x2002<br>..##.......####..##.##.....##...####...##.....##.##.....##&#x2002&#x2002&#x2002&#x2002<br>..######...##.##.##.##.....##....##....##.....##.##.....##&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002&#x2002<br>&#x2002&#x2002##.......##..####.##.....##....##....##.....##.##.....##&#x2002&#x2002&#x2002&#x2002<br>&#x2002.##.......##...###.##.....##....##....##.....##.##.....##&#x2002<br>&#x2002.########.##....##.########.....##.....#######...#######.</p></div></span>'
                });
            } else if (vInput.trim() !== "") {
